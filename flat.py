...
df=pd.read_csv(r'C:\Users\Shifas\Documents\PROJECTS-2023\6.Singapore_Project\final.csv')
...
with tab3:
    ...
    if st.button('Predict and Conclusion'):
            ...
            def load_data():
                # Load data
                data = pd.read_csv(r'C:\Users\shifas\Documents\PROJECTS-2023\6.Singapore_Project\final.csv')
